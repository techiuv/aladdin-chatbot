  ...
  return (
    <>
      ...
      <div className=" bg-secondary flex justify-center items-center flex-col h-screen w-screen ">
        <h2 className="text-[3rem] capitalize font-bold text-white text-center mb-4">Welcome Back!</h2>


        <form onSubmit={handleSubmit(handleLogin)} className="w-[40%] mx-auto p-5 rounded-lg">
        ...
        <div>
          <p className='text-lg text-textlight'>Don't have a  account? <Link to={'/auth/register'} className='text-white underline'>SignUp</Link></p>
        </div>
      </div>
    </>
  );
